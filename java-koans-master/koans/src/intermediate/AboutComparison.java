...
public class AboutComparison {
    ...
    public void makeObjectsComparableWithoutComparable() {
        ...
        RaceHorse[] horses = new intermediate.AboutComparison.RaceHorse[]{lindy, slowy, lightning};

        Arrays.sort(horses, new HorseAgeComparator());
        assertEquals(horses[0], lightning);             //"Speed: 10 Age: 2"
        Arrays.sort(horses, new HorseSpeedComparator());
        assertEquals(horses[0], slowy);            //"Speed: 1 Age: 12"
    }
}
